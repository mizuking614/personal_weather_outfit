...
11. ユースケース  
    ・平日の朝: 「出発時は涼しいけど、お昼は暑くなる」という日に、レイヤリングモードが発動して「半袖+脱げるカーディガン」を提案  
    ・帰宅が遅い日: 「夜21時の気温が7℃まで下がる」ことを予測し、朝の段階で「マフラー持参」を推奨  
    ・季節の変わり目: 前日に寒いとフィードバックすれば、同じ気温でも「今日は昨日よりも厚手のものを」と調整して提案  
12. 運用・拡張プラン  
